...
export function RetailBusinessLatestNews() {
  const newsItems = [
    {
      image: "/assets/news1.jpg",
      title: "The Future of Sanctions Compliance",
      description: "Beyond Obligation: The New Face of Compliance",
      link: "#",
    },
    {
      image: "/assets/news2.jpg",
      title: "Harnessing AI’s Potential in Wealth Management",
      description: "AI is driving a major shift in APAC and MEA wealth management.",
      link: "#",
    },
    {
      image: "/assets/new3.jpg",
      title: "Next-generation payment innovations: QRIS, E-Wallets, Digital Rupiah, and BNPL.",
      description:
        "QRIS, e-wallets, and BNPL are redefining digital payments in Indonesia with speed and innovation.",
      link: "#",
    },
  ]
