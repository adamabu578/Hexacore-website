      ...
      <div className="container px-4 md:px-6 text-center">
        ...
        <div className="relative max-w-3xl mx-auto">
          <p className="text-lg md:text-xl italic text-temenos-gray mb-6">
            &ldquo;Our investments in Temenos products have allowed us to transition into a modern, digital bank with
            improved speed, reliability, and flexibility. These performance benefits are key enablers of our
            success.&rdquo;
          </p>
          <p className="font-semibold text-temenos-blue">Ahmed AlZikan</p>
          <p className="text-sm text-temenos-gray mb-6">Chief IT Governance Officer, Bank Albilad</p>
          <Link href="#" className="inline-flex items-center text-temenos-blue hover:underline font-medium">
            Explore Bank Albilad&apos;s story <ArrowRight className="ml-2 h-4 w-4" />
          </Link>
