  ...
  return (
    <section className="w-full py-12 md:py-24 lg:py-32 bg-white">
      <div className="container px-4 md:px-6 text-center">
        <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-12 text-[#153365]">Real results</h2>
        <div className="relative flex items-center justify-center">
          <Button variant="ghost" size="icon" className="absolute left-0 rounded-full">
            <ArrowLeft className="h-6 w-6 text-[#28B1D3] " />
            <span className="sr-only">Previous testimonial</span>
          </Button>
          <div className="max-w-3xl mx-auto text-center">
            <p className="text-xl md:text-2xl italic text-temenos-gray mb-6">
              {
                "Hexacore' people are key. Its services, products, and account management teams have really been outstanding. They have enabled us to be very agile and deliver with speed and confidence. That we concentrate its growth efforts on Northwest Europe, was exemplified when the bank pivoted to concentrate its growth efforts on Northwest Europe, and the partnership allowed for a smooth adjustment. We were able to do that knowing that Temenos could flex with us and so minimize any disruption."
              }
            </p>
            <p className="font-semibold text-[#153365]">samuel joseph</p>
          ...
          <Button variant="ghost" size="icon" className="absolute right-0 rounded-full">
            <ArrowRight className="h-6 w-6 text-[#28B1D3]" />
