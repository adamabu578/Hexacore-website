...
export function FutureOfBankingCta() {
  return (
      ...
      <div className="container px-4 md:px-6 grid lg:grid-cols-2 gap-8 items-center">
        <div className="space-y-4">
          ...
          <p className="max-w-[600px] text-temenos-gray md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
           Our platform empowers financial institutions to adapt, innovate, and deliver faster, smarter banking. Together, we lead the future of finance.
          </p>
        </div>
