      ...
      <div className="container px-4 md:px-6 text-center">
        ...
        <div className="relative max-w-3xl mx-auto">
          <p className="text-lg md:text-xl italic text-temenos-gray mb-6">
            &ldquo;We recognize that a modern core banking platform is an accelerator for innovation and digital
            customer experiences. The Temenos platform will enable Commerce to deliver innovative solutions for our
            customers today and well into the future.&rdquo;
          </p>
          <p className="font-semibold text-temenos-blue">David Roller</p>
          <p className="text-sm text-temenos-gray mb-6">Chief Information Officer, Commerce Bank</p>
          <Link href="#" className="inline-flex items-center text-temenos-blue hover:underline font-medium">
            Explore Commerce Bank&apos;s story <ArrowRight className="ml-2 h-4 w-4" />
          </Link>
