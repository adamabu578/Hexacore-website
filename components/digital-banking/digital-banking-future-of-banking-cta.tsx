      ...
      <div className="container px-4 md:px-6 grid lg:grid-cols-2 gap-8 items-center">
        <div className="space-y-4">
          ...
          <p className="max-w-[600px] text-temenos-gray md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
           Our platform empowers financial institutions to adapt to change, capitalize on new opportunities, and provide smarter, faster banking—Leading Banking Forward.
          </p>
        </div>
        <div className="flex flex-col justify-center lg:justify-end space-y-4">
          <Card className="w-full p-6 rounded-lg shadow-lg bg-white text-[#153365]">
            <CardContent className="flex flex-col items-start space-y-4">
              <Link href="#" className="inline-flex items-center font-medium hover:underline">
                Contact the team <ArrowRight className="ml-2 h-4 w-4 text-[#28B1D3]" />
              </Link>
            </CardContent>
          </Card>
          <Card className="w-full p-6 rounded-lg shadow-lg bg-white text-[#153365]">
            <CardContent className="flex flex-col items-start space-y-4">
              <Link href="#" className="inline-flex items-center font-medium hover:underline">
                Attend an event <ArrowRight className="ml-2 h-4 w-4 text-[#28B1D3]" />
              </Link>
            </CardContent>
          </Card>
          <Card className="w-full p-6 rounded-lg shadow-lg bg-white text-[#153365]">
            <CardContent className="flex flex-col items-start space-y-4">
              <Link href="#" className="inline-flex items-center font-medium hover:underline">
                Explore resources <ArrowRight className="ml-2 h-4 w-4 text-[#28B1D3]" />
              </Link>
            </CardContent>
          </Card>
          <Card className="w-full p-6 rounded-lg shadow-lg bg-white text-[#153365]">
            <CardContent className="flex flex-col items-start space-y-4">
              <Link href="#" className="inline-flex items-center font-medium hover:underline">
                Newsletter sign-up <ArrowRight className="ml-2 h-4 w-4 text-[#28B1D3]" />
              </Link>
            </CardContent>
          </Card>
        </div>
